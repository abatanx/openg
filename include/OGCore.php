...
class OGCore
{
	...
	public function __construct()
	{
		if ( ! wg_is_mobile() )
		{
			$this->modules = new OPENGModulesCollection( OPENGModulesCollection::MT_PC );
		}
		else
		{
			$this->modules = new OPENGModulesCollection( OPENGModulesCollection::MT_MOBILE );
		}
		$this->modules->scan();

		$this->wiki = new OPENGWiki();
		$this->wiki->scanModuleWikiPattern( $this->modules );
	}
}
